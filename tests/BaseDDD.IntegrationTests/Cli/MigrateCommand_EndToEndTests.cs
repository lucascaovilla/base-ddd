// <copyright file="MigrateCommand_EndToEndTests.cs" company="BaseDDD">
// Copyright (c) BaseDDD.
...
public class MigrateCommand_EndToEndTests(GeneratedProjectFixture fixture)
{
    ...
    [Fact]
    public void Should_Have_BaseDddJson_After_New()
    {
        Assert.True(File.Exists(Path.Combine(this.fixture.ProjectPath, "baseddd.json")));
    }

    [Fact]
    public void BaseDddJson_Should_Contain_Expected_Fields()
    {
        string content = File.ReadAllText(Path.Combine(this.fixture.ProjectPath, "baseddd.json"));
    ...
    [Fact]
    public void BaseDddJson_Should_Contain_Current_TemplateVersion()
    {
        string content = File.ReadAllText(Path.Combine(this.fixture.ProjectPath, "baseddd.json"));
        using System.Text.Json.JsonDocument doc = System.Text.Json.JsonDocument.Parse(content);
