// <copyright file="BaseDddJsonTemplateTests.cs" company="BaseDDD">
// Copyright (c) BaseDDD.
...
public class BaseDddJsonTemplateTests
{
    [Fact]
    public void Should_Be_Valid_Json()
    {
        string content = BaseDddJsonTemplate.Generate(
            "1.0.0",
            "1.0",
    ...
    public void Should_Preserve_CreatedAt_Different_From_UpdatedAt()
    {
        ...
        string content = BaseDddJsonTemplate.Generate("1.0.0", "1.0", createdAt, updatedAt);
