...
public class FileSystemTests
{
    ...
    public void WriteFile_Should_Create_File_And_Content()
    {
        ...
        BaseDDD.Infrastructure.FileSystem.WriteFile(path, "content");
    ...
    public void CreateDirectory_Should_Create_Directory()
    {
        ...
        BaseDDD.Infrastructure.FileSystem.CreateDirectory(path);
    ...
    public void DeleteIfExists_Should_Delete_File()
    {
        ...
        BaseDDD.Infrastructure.FileSystem.DeleteIfExists(path);
