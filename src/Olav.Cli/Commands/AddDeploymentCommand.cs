// <copyright file="AddDeploymentCommand.cs" company="Olav">
// Copyright (c) Olav.
...
/// <summary>
/// Handles <c>olav add deployment &lt;source&gt; [--paramName value …]</c>.
...
/// </summary>
public static class AddDeploymentCommand
{
    /// <summary>
    /// Executes the <c>add deployment</c> command.
    /// </summary>
    /// <param name="args">Full argument list (including the leading <c>add deployment</c> tokens).</param>
    public static void Execute(string[] args)
    {
        if (args.Length < 3)
        {
            Console.WriteLine("Usage: olav add deployment <source> [--paramName value …]");
            return;
        }
    ...
    private static void PromptMissingParameters(
